...
export default function StudentCreateEnrollForm({
  ...
  React.useEffect(() => {
    ...
    console.log("watchedPayeId:", watch("payeId"));
    console.log("watchedReshtehTahsiliId:", watch("reshtehTahsiliId"));
    console.log("watchedKlassId:", watch("klassId"));
    console.log("=============");
  }, [errors, isSubmitting, showForm, studentFound]);
  /*
